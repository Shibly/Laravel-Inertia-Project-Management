                                            ...
                                            <td className="px-3 py-2 text-nowrap">
                                                <div className="flex space-x-2 justify-center">
                                                    ...
                                                    <button onClick={(e) => deleteUser(user)}
                                                            className="flex-1 px-2 py-1 bg-red-500 text-white text-center font-medium text-sm rounded hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700">Delete
                                                    </button>
