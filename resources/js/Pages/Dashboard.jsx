...
export default function Dashboard({auth, warning, success, tasksSummary, projectsSummary}) {
                            ...
                            <div className="flex justify-center space-x-6">
                                ...
                                <div className="bg-gray-800 text-white rounded-lg p-4 flex-1">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div className="text-right">
                                            <span className="text-3xl font-bold">{projectsSummary.total_projects}</span>
                                ...
                                <div className="bg-gray-800 text-white rounded-lg p-4 flex-1">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div className="text-right">
                                            <span className="text-3xl font-bold">{tasksSummary.total_tasks}</span>
                                    ...
                                    <div className="mt-4">
                                        <ul className="space-y-2">
                                            ...
                                            <li className="text-yellow-400">In Progress: {tasksSummary.in_progress}</li>
